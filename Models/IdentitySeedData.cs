    ...
    public static class IdentitySeedData {
        ...
        public static async void SeedDatabase(IApplicationBuilder app) {
            ...
            if (role == null) {
                ...
                if (!result.Succeeded) {
                    throw new Exception("Não Será possivel criar um papel: " 
            ...
            if (user == null) {
                ...
                if (!result.Succeeded) {
                    throw new Exception("Não foi possivel criar um usuário " 
                        + result.Errors.FirstOrDefault());                    
                }
            }
            ...
            if (!await userManager.IsInRoleAsync(user, adminRole)) {
                ...
                if (!result.Succeeded) {
                    throw new Exception("Não foi possivel adicioanr um papel ao usuário: " 
                        + result.Errors.FirstOrDefault());
                }
            }
        }
